...
# model = Sequential()
# model.add(Convolution1D(64, 1, activation='relu', input_shape=(num_points, 3)))
# model.add(BatchNormalization())
# model.add(Convolution1D(128, 1, activation='relu'))
# model.add(BatchNormalization())
# model.add(Convolution1D(256, 1, activation='relu'))
# model.add(BatchNormalization())
...
# model.add(BatchNormalization())
# model.add(Dense(9, weights=[np.zeros([256, 9]), np.array([1, 0, 0, 0, 1, 0, 0, 0, 1]).astype(np.float32)]))
